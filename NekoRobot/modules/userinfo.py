...
def info(update: Update, context: CallbackContext):
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="Health", url="https://t.me/Anya_updates/13"
            ),
            InlineKeyboardButton(
                text="Disasters", url="https://t.me/Anya_updates/10"
            ),
        ],
    ]
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + f"\n\n[✦ Support](https://t.me/axpsupport) | [✦ Updates](https://t.me/Anya_updates)\n\n"
            + "\n╘══「 by [MAC • Network](https://t.me/macnetwork7) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Repo", url="https://youtu.be/dQw4w9WgXcQ"
                        )
                    ]
                ]
            ),
